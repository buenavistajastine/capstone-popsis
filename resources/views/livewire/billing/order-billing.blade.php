                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <small>#<i>{{ optional($billing->foodOrders)->order_no }}</i></small>
                                                    </div>
                                                </div>
                                            </td>
...
<div wire.ignore.self class="modal fade" id="orderBillingModal" tabindex="-1" aria-labelledby="orderBillingModal" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
