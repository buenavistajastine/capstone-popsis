                        ...
                        <div class="dash-content">
                            @foreach ($booking->dish_keys as $dishKey)
                                <div class="form-check">
                                    <input class="form-check-input checkbox-class" type="checkbox" value="{{ $dishKey->dishes->id }}" id="dish_{{ $dishKey->dishes->id }}">
                            ...
                            @foreach ($booking->addOns as $addOn)
                                <div class="form-check">
                                    <input class="form-check-input checkbox-class" type="checkbox" value="{{ $addOn->dishss->id }}" id="addon_{{ $addOn->dishss->id }}">
