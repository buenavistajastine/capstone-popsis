            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group flatpickr" id="flatpickr-date">
                        <input type="text" class="form-control flatpickr-input" placeholder="yy/mm/dd" wire:model="birthdate" data-input>
                        <span class="input-group-text input-group-addon" data-toggle><i class="fa-regular fa-calendar"></i></span>
                      </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="form-group local-forms">
